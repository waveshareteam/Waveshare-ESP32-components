...
/**
 * @brief SSD1315 configuration structure
 *
 * To be used as esp_lcd_panel_dev_config_t.vendor_config.
 * See esp_lcd_new_panel_ssd1315().
 */
typedef struct {
    /**
     ...
     */
    uint8_t height;
} esp_lcd_panel_ssd1315_config_t;

/**
 * @brief Create LCD panel for model SSD1315
 *
 ...
 * @note Use esp_lcd_panel_ssd1315_config_t to set the correct size.
 * Example usage:
 * @code {c}
 *
 ...
 * esp_lcd_new_panel_ssd1315(io_handle, &panel_config, &panel_handle);
 * @endcode
 */
