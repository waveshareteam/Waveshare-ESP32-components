# Waveshare ESP32-S3-LR1121-OLED-1.54 Display Support

[![Component Registry](https://components.espressif.com/components/waveshare/esp_oled_ssd1309/badge.svg)](https://components.espressif.com/components/waveshare/esp_oled_ssd1309)

Waveshare ESP32-S3-LR1121-OLED-1.54 Display used I2C

| OLED controller | Communication interface | Component name |                               Link to datasheet                               |
| :------------: |:-----------------------:| :------------: | :---------------------------------------------------------------------------: |
|     SSD1309     |          I2C           | esp_oled_ssd1309 | [PDF](https://files.waveshare.com/upload/9/9c/SSD1309Datasheet.pdf) |
...
```
    idf.py add-dependency "waveshare/esp_oled_ssd1309"
```
