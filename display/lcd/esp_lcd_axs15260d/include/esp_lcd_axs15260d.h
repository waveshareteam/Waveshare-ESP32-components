 ...
 */
typedef struct {
    const axs15260d_lcd_init_cmd_t *init_cmds;         /*!< Pointer to initialization commands array. Set to NULL if using default commands.
...
} axs15260d_vendor_config_t;

/**
 * @brief Create LCD panel for model axs15260d
 *
 ...
 *
 */
#define AXS15260D_PANEL_BUS_DSI_2CH_CONFIG()             \
    {                                                    \
        .bus_id = 0,                                     \
        .num_data_lanes = 2,                             \
        .phy_clk_src = 0,                                \
        .lane_bit_rate_mbps = 1100,                      \
    }
 ...
 *
 */
#define AXS15260D_PANEL_IO_DBI_CONFIG()  \
    {                                   \
        .virtual_channel = 0,           \
        .lcd_cmd_bits = 8,              \
        .lcd_param_bits = 8,            \
 ...
 *
 */
#define AXS15260D_452_1280_PANEL_60HZ_DPI_CONFIG(px_format) \
    {                                                       \
 ...
 *
 */
#define AXS15260D_452_1280_PANEL_60HZ_DPI_CONFIG_CF(color_format) \
    {                                                            \
        .dpi_clk_src = MIPI_DSI_DPI_CLK_SRC_DEFAULT,             \
        .dpi_clock_freq_mhz = 62,                                \
        .virtual_channel = 0,                                    \
