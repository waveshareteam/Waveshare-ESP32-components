...
// Pinout for WAVESHARE_ESP32_S3_TOUCH_LCD_4_3C
#define I2C_MASTER_SCL_IO   9          /*!< gpio number for I2C master clock */
#define I2C_MASTER_SDA_IO   8          /*!< gpio number for I2C master data  */
#define I2C_MASTER_NUM      I2C_NUM_0   /*!< I2C port number for master dev */
#define I2C_ADDRESS         CUSTOM_IO_EXPANDER_I2C_CH32V003_ADDRESS
/*!< I2C address of slave dev */

#define TEST_LOOP_CNT       10
#define TEST_LOOP_DELAY_MS  500
#define TEST_OUTPUT_PINS    (IO_EXPANDER_PIN_NUM_2 | IO_EXPANDER_PIN_NUM_6 | IO_EXPANDER_PIN_NUM_7)
#define TEST_INPUT_PINS     (IO_EXPANDER_PIN_NUM_0 | IO_EXPANDER_PIN_NUM_5)

static const char *TAG = "custom_io test";
...
static void i2c_dev_custom_io_init(void)
{
    esp_err_t ret = custom_io_expander_new_i2c_ch32v003(i2c_handle, I2C_ADDRESS, &io_expander);
    TEST_ASSERT_EQUAL_MESSAGE(ESP_OK, ret, "CUSTOM IO create returned error");
}

static void i2c_dev_custom_io_deinit(void)
{
    esp_err_t ret = esp_io_expander_del(io_expander);
    TEST_ASSERT_EQUAL_MESSAGE(ESP_OK, ret, "CUSTOM IO delete returned error");
}

TEST_CASE("IO expander custom_io test", "[custom_io]")
{
    i2c_bus_init();
