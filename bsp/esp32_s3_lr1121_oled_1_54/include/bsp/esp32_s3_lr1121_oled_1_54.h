...
/** @defgroup g02_lora LoRa
 *  @brief LoRa BSP API
 *  @{
 */
#define BSP_SPI_CLK_SPEED_HZ     8 * 1000 * 1000
#define BSP_SPI_NUM              (SPI3_HOST)

#define BSP_SPI_MOSI             (GPIO_NUM_45)
#define BSP_SPI_MISO             (GPIO_NUM_46)
#define BSP_SPI_CLK              (GPIO_NUM_40)
#define BSP_SPI_CS               (GPIO_NUM_42)
#define BSP_SPI_INT              (GPIO_NUM_38)
#define BSP_SPI_RESET            (GPIO_NUM_39)
#define BSP_SPI_BUSY             (GPIO_NUM_41)
...
#define BSP_I2S_DOUT            (GPIO_NUM_16)    // To Codec ES8311
#define BSP_I2S_DSIN            (GPIO_NUM_15)   // From ADC ES7210
#define BSP_POWER_AMP_IO        (GPIO_NUM_8)
/** @} */ // end of audio

/* Display */
#define BSP_OLED_SDA     (GPIO_NUM_13)
#define BSP_OLED_SCL     (GPIO_NUM_14)
#define BSP_OLED_RST     (GPIO_NUM_NC)
...
#define BSP_OLED_I2C_ADDRESS    (SSD1309_I2C_ADDRESS_L)
...
/**
 * @brief Get input device
 *
 * @return Pointer to input device or NULL when error occurred
 */
