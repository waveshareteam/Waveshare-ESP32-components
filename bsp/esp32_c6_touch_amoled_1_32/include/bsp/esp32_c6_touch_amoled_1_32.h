...
#define BSP_I2S_SCLK          (GPIO_NUM_3)
#define BSP_I2S_MCLK          (GPIO_NUM_15)
#define BSP_I2S_WS            (GPIO_NUM_5)
#define BSP_I2S_DOUT          (GPIO_NUM_6)
#define BSP_I2S_DSIN          (GPIO_NUM_4)
#define BSP_POWER_AMP_IO      (GPIO_NUM_23)

/* Display */
#define BSP_LCD_CS        (GPIO_NUM_22)
#define BSP_LCD_PCLK      (GPIO_NUM_18)
#define BSP_LCD_DATA0     (GPIO_NUM_19)
#define BSP_LCD_DATA1     (GPIO_NUM_20)
