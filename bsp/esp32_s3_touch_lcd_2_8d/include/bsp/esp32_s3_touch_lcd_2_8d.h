...
/* WS2812B */
#define BSP_WS2812_PIN           (GPIO_NUM_38)
...
#define BSP_I2S_DOUT            (GPIO_NUM_11)    // To Codec ES8311
#define BSP_I2S_DSIN            (GPIO_NUM_10)   // From ADC ES7210
#define BSP_POWER_AMP_IO        (IO_EXPANDER_PIN_NUM_6)

/* Display */
#define BSP_LCD_VSYNC     (GPIO_NUM_40)
#define BSP_LCD_HSYNC     (GPIO_NUM_39)
#define BSP_LCD_DE        (GPIO_NUM_41)
#define BSP_LCD_PCLK      (GPIO_NUM_42)
#define BSP_LCD_DISP      (GPIO_NUM_NC)
#define BSP_LCD_DATA0     (GPIO_NUM_43)
#define BSP_LCD_DATA1     (GPIO_NUM_44)
#define BSP_LCD_DATA2     (GPIO_NUM_45)
#define BSP_LCD_DATA3     (GPIO_NUM_47)
#define BSP_LCD_DATA4     (GPIO_NUM_48)
#define BSP_LCD_DATA5     (GPIO_NUM_7)
#define BSP_LCD_DATA6     (GPIO_NUM_8)
#define BSP_LCD_DATA7     (GPIO_NUM_9)
#define BSP_LCD_DATA8     (GPIO_NUM_17)
#define BSP_LCD_DATA9     (GPIO_NUM_18)
#define BSP_LCD_DATA10    (GPIO_NUM_21)
#define BSP_LCD_DATA11    (GPIO_NUM_2)
#define BSP_LCD_DATA12    (GPIO_NUM_3)
#define BSP_LCD_DATA13    (GPIO_NUM_4)
#define BSP_LCD_DATA14    (GPIO_NUM_5)
#define BSP_LCD_DATA15    (GPIO_NUM_6)

#define BSP_LCD_IO_SPI_CS (IO_EXPANDER_PIN_NUM_3)
#define BSP_LCD_IO_SPI_SCL (IO_EXPANDER_PIN_NUM_5)
#define BSP_LCD_IO_SPI_SDA (IO_EXPANDER_PIN_NUM_4)

#define BSP_LCD_BACKLIGHT     (GPIO_NUM_46)
#define BSP_LCD_RST           (GPIO_NUM_NC)
#define BSP_LCD_TOUCH_RST     (IO_EXPANDER_PIN_NUM_1)
#define BSP_LCD_TOUCH_INT     (IO_EXPANDER_PIN_NUM_2)

#define BSP_IO_EXPANDER_I2C_ADDRESS     (ESP_IO_EXPANDER_I2C_TCA9555_ADDRESS_000)

#define LVGL_BUFFER_HEIGHT          (CONFIG_BSP_DISPLAY_LVGL_BUF_HEIGHT)

/* uSD card */
#define BSP_SD_D0            (GPIO_NUM_19)
 ...
 **************************************************************************************************/ 
/**
 * @brief Init IO expander chip TCA9555
 *
...
/**
 * @brief Convert RTC datetime structure to a formatted string
 *
 * This function converts the provided PCF85063A RTC datetime structure
 * into a human-readable string format, e.g., "YYYY-MM-DD HH:MM:SS".
 *
 * @param[out] datetime_str   Buffer to store the formatted datetime string. 
 *                            Must be large enough to hold the output.
 * @param[in]  time           RTC datetime structure to convert.
 *
 * @return
 *      - ESP_OK: Conversion succeeded.
 *      - ESP_ERR_INVALID_ARG: Invalid argument (e.g., datetime_str is NULL).
 */
