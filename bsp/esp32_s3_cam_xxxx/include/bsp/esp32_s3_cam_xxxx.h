...
/**
 * @file
 * @brief ESP BSP: ESP32-S3-CAM-XXXX
 */
 ...
 *  @{
 */
#define BSP_I2S_SCLK          (GPIO_NUM_11)
#define BSP_I2S_MCLK          (GPIO_NUM_10)
#define BSP_I2S_LCLK          (GPIO_NUM_12)
#define BSP_I2S_DOUT          (GPIO_NUM_14)  
#define BSP_I2S_DSIN          (GPIO_NUM_13)
 ...
 *  @{
 */
#define BSP_CAMERA_XCLK      (GPIO_NUM_38)
#define BSP_CAMERA_PCLK      (GPIO_NUM_41)
#define BSP_CAMERA_VSYNC     (GPIO_NUM_17)
#define BSP_CAMERA_HSYNC     (GPIO_NUM_18)
#define BSP_CAMERA_D0        (GPIO_NUM_45)
#define BSP_CAMERA_D1        (GPIO_NUM_47)
#define BSP_CAMERA_D2        (GPIO_NUM_48)
#define BSP_CAMERA_D3        (GPIO_NUM_46)
#define BSP_CAMERA_D4        (GPIO_NUM_42)
#define BSP_CAMERA_D5        (GPIO_NUM_40)
#define BSP_CAMERA_D6        (GPIO_NUM_39)
#define BSP_CAMERA_D7        (GPIO_NUM_21)
/** @} */ // end of camera
 ...
 *  @{
 */
#define BSP_BATTERY_VOLTAGE   (GPIO_NUM_NC)  // Connected via IO expander ADC
/** @} */ // end of battery
...
#define BSP_BUTTONS_IO_1       (GPIO_NUM_15) 
/** @} */ // end of buttons
 ...
 *
 * The current mass-produced version uses CH32V003 , while a small number of older versions use CH32V003 .
 *
 **************************************************************************************************/
 #define BSP_IO_EXPANDER_I2C_ADDRESS_CH32V003   (CUSTOM_IO_EXPANDER_I2C_CH32V003_ADDRESS)

/**
 * @brief Init IO expander chip CH32V003 
 *
...
/**
 * @brief get IO expander handle CH32V003 
 *
 * @note I2C must be already initialized by bsp_i2c_init()
 * @note If the device was already initialized, users can also call it to get handle
 *
...
/**
 * @brief get IO expander adc CH32V003 
 *
 * @note I2C must be already initialized by bsp_i2c_init()
 * @note If the device was already initialized, users can also call it to get handle
 *
 ...
 * Camera interface
 *
 * ESP32-S3-CAM-XXXX has connector for camera.
 ...
 **************************************************************************************************/
/**
 * @brief ESP32-S3-CAM-XXXX camera default configuration
 *
